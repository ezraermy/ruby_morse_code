...
**morse_code** This project creates three methods that work together to decode Morse code characters, words, and messages by utilizing the decode_char and decode_word methods.
...
```bash
git clone https://github.com/ezraermy/ruby-morse-code.git
```
